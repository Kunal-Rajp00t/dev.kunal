        ...
        <div className='mainSolves' id='solves'>
            ...
            <div className="solvesBody">
                ...
                <div className="wBox">
                    ...
                    <div className="mainText">I have actively engaged with LeetCode to sharpen my <span className="special">problem-solving skills</span> and <span className="special">algorithmic thinking</span>. I've solved over <span className="special">1000+ problems</span>  and achieved a highest contest rating of 1750+. My dedication to continuous improvement is reflected in the numerous badges I've earned, showcasing my proficiency in various programming concepts and data structures. <a href="https://leetcode.com/u/Kunal_Rajput_/" target='_blank' rel="noreferrer">Visit Profile</a> </div>
                </div>
                <div className="wBox2">
